...
namespace UnderworldEditor
{
    public class UWStrings
    {
        ...
        /// <summary>
        /// Loads and decodes the strings.pak file as specified by the Path.
        /// </summary>
        /// <param name="path">Path.</param>
        public void LoadStringsPak(string path,int game, System.Windows.Forms.DataGridView grdStrings)
        {
                        ...
                        do
                        {
                            ...
                            else
                            {
                                if ((Result.Length > 0) && (Key.Length > 0))
                                {
                                    ...
                                    //add rows
                                    int rowId = grdStrings.Rows.Add();
                                    System.Windows.Forms.DataGridViewRow row = grdStrings.Rows[rowId];
        ...
        /// <param name="index">Index.</param>
        public string GetTextureName(int index,int game)
        {
            switch (game)
            {
                case 2:
